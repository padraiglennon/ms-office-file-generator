...
| [ADR-015](ADR-015-screenshot-drift-precommit-guard.md) | Warn-only pre-commit guard for UI screenshot drift | Done | [#24](https://github.com/padraiglennon/common-file-generator/issues/24) |
